...
CATEGORICAL_TO_IMPUTE = ['MasVnrType', 'BSmtQual',
...
CATEGORICAL_ENCODE = ['MSZoning', 'Neighborhood', 'RoofStyle',
                      ...
                      'CentralAir', 'KitchenQual', 'FireplaceQu', 'GarageType', 'GarageFinish', 'PaveDrive']

# selected features for training

FEATURES = ['MSSubClass', 'MSZoning', 'Neighborhood', 'OverallQual',
            'OverallCond', 'YearRemodAdd', 'RoffStyle', 'MasVnrType',
